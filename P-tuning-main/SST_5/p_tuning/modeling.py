...
from SST_5.p_tuning.models import get_embedding_layer, create_model
from SST_5.data_utils.vocab import get_vocab_by_strategy, token_wrapper
from SST_5.data_utils.dataset import load_file
from SST_5.p_tuning.prompt_encoder import PromptEncoder
...
class PTuneModel(torch.nn.Module):
    ...
    def __init__(self, args, device, template):
        ...
        self.allowed_vocab_ids = set(self.vocab[k] for k in get_vocab_by_strategy(self.args, self.tokenizer)) #vocab[k]是序号,vocab是字符-序号字典
